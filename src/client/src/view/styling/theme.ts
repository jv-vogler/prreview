/**
 * Theme model (ARCHITECTURE §10): the user picks a mode (light, dark, or
 * auto), the provider resolves `auto` against the OS preference, and the root
 * element carries Primer's scheme attributes plus our computed
 * `data-resolved-theme` so our CSS and Pierre key off one concrete attribute.
 *
