 ...
 * the chevron, a link — belongs to that control, which is why the walk stops
 * at the first interactive element it meets on the way up. And a click that
 * ends a text selection is someone copying a path, not someone asking for
