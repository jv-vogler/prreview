// Pre-paint theme application (ARCHITECTURE §10). Loaded as a blocking classic
// script from index.html <head> so the attributes exist before first paint —
// the ThemeProvider takes over after hydration and keeps them live.
