 ...
 * or a server restart does not lose it. One artifact per changeset (one
 * review pass, no rounds, no history) rather than the rounds/coverage/chat
 * layout of the old implementation.
 */
