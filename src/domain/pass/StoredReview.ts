 ...
 * to it, and what it was measured against. This is the noun the
 * `SessionStore` port loads and saves; the port declares that behaviour and
 * nothing about this shape, so anything that only reads the artifact stays
 * domain code.
 */
/**
