 ...
 * line number on either side to the id of the hunk containing it
 * (ARCHITECTURE §5). Derived from the IR rather than stored, because the IR
 * snapshot is plain JSON and Maps do not survive it.
 */
